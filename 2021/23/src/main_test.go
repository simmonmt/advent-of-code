...
func TestGameStateSerialize(t *testing.T) {
	gs := NewGameState(2, [4][]pos.P2{
		[]pos.P2{pos.P2{1, 2}, pos.P2{3, 4}},
		[]pos.P2{pos.P2{5, 6}, pos.P2{7, 8}},
		[]pos.P2{pos.P2{10, 20}, pos.P2{30, 40}},
		[]pos.P2{pos.P2{50, 60}, pos.P2{70, 80}},
	})

	ser := gs.Serialize()
	want := "2|1,2|3,4|5,6|7,8|10,20|30,40|50,60|70,80"
	if ser != want {
...
func TestAllNeighbors(t *testing.T) {
	...
	testCases := []TestCase{
		TestCase{
			seq: []string{
				//  A   A   B   B   C   C   D   D
				"2|2,2|8,2|2,1|6,1|4,1|6,2|4,2|8,1",
				"2|2,2|8,2|2,1|3,0|4,1|6,2|4,2|8,1",
				"2|2,2|8,2|2,1|3,0|6,1|6,2|4,2|8,1",
				"2|2,2|8,2|2,1|3,0|6,1|6,2|5,0|8,1",
				"2|2,2|8,2|2,1|4,2|6,1|6,2|5,0|8,1",
				"2|2,2|8,2|4,1|4,2|6,1|6,2|5,0|8,1",
				"2|2,2|8,2|4,1|4,2|6,1|6,2|5,0|7,0",
				"2|2,2|9,0|4,1|4,2|6,1|6,2|5,0|7,0",
				"2|2,2|9,0|4,1|4,2|6,1|6,2|5,0|8,2",
				"2|2,2|9,0|4,1|4,2|6,1|6,2|8,1|8,2",
				"2|2,1|2,2|4,1|4,2|6,1|6,2|8,1|8,2",
			},
		},
	}
...
func TestNeighborDistance(t *testing.T) {
	...
	testCases := []TestCase{
		TestCase{
			n1:   "2|2,1|2,2|4,1|4,2|6,1|6,2|9,0|8,2",
			n2:   "2|2,1|2,2|0,0|4,2|6,1|6,2|9,0|8,2",
			want: 50,
		},
	}
